...
// Components
import PinnedButtons from "./pinned_buttons/PinnedButtons.vue";
import Stats from "@/components/datasets/manager/single/header/Stats.vue";
import DeleteDatasetButton from "@/components/datasets/manager/single/header/DeleteDatasetButton.vue";

export default defineComponent({
    components: { Stats, DeleteDatasetButton, PinnedButtons },
    setup() {
