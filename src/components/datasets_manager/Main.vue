<template>
    <section id="certain-datasets-manager" class="bigger">
...
import WordsManagerHeader from "@/components/datasets_manager/header/Header.vue";
import Modifier from "@/components/datasets_manager/modify/Modifier.vue";
import ExitModal from "@/components/datasets_manager/ExitModal.vue";
...
export default defineComponent({
    components: { WordsManagerHeader, Modifier, ImportingResultCommunique, ExitModal },
    async setup() {
        const { loadDatasetsInfo } = useModifier;
