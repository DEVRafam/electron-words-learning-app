    ...
    <section id="current-words">
        <header>
            <h3>
                ...
                <strong>({{ wordsToDelete.length }} of {{ datasetWords.length }})</strong>
            </h3>
...
export default defineComponent({
    async setup() {
        ...
        //
        await loadDatasetWords();
        //
        return { onlySelected, datasetWords, isWordInDeletingList, prepareWordForDeleting, buttonMsg, wordsToDelete };
    },
});
</script>
